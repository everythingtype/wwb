...
if ( ! class_exists( 'RP4WP_Is_Installing_Notice' ) ) {
	...
	class RP4WP_Is_Installing_Notice {
		...
		public function content() {
			...
			$install_query_string = admin_url( sprintf( '?page=rp4wp_install&pt=%s&step=2&rp4wp_nonce=%s', get_option( RP4WP_Constants::OPTION_IS_INSTALLING ), wp_create_nonce( RP4WP_Constants::NONCE_INSTALL ) ) );
